...
function x0 = KIL22(n,c,e1,e3,T2,V2,x,ah,bn,HF,Xf,f,x1,x2)   
% x1,x2 - предыд корни
%global Ep9 Ep8
...
while true
   ...
   if     h<0 && C<x2,  x0 = sprintf('KIL22: %g=C < x2=%g',C,x2); return
   elseif h>0 && C>(Xf+2*x2-x1)/2,  x0 = 'KIL22: C > (Xf+x)/2'; return
   end
end